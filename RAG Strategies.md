...
## 🏗️ Platinum Implementation Flow
...
graph TD
    ...
    subgraph "Retrieval Engine"
        Router --> |@mentions| Targeted[Enforced File Filter]
        Router --> |Global| Vector[HNWS Vector Search]
        
        Targeted & Vector --> Candidate[Candidate Pool: Top 20]
        Candidate --> Window[Neighbor Window Expansion]
        Window --> Rerank[FlashRank Re-ranker]
    end

    subgraph "Generation Engine"
        Rerank --> |Top 5| Generator[Adaptive Meta-Prompt]
        Generator --> |Refine| Output[Synthesized Answer]
    end
```
