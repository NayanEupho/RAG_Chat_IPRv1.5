...
FR-05: Content workflow (Create Review Approve $\rightarrow$ Publish)
...
FR-NEW-09: R&D Activities structured as:

ADG Simply Innovative

Group Division $\rightarrow$ Section
...
Source dornains/IP addresses

Referrers

Page-wise hit rates

FR-15: The system shall generate reports on content modification activities with timeline filters,

username and title of page.
...
Fast response time: 1 seconds under normal load
...
-https://www.stac.gov.in/sites/default/files/2025-06/DBIM%20Manual%20V%20203 0.pdf). (Optional, subject to design requirements and project needs.)
...
Malware scanning for uploads - IT will be performed using security tools

Automatic daily backups

Backup storage on a dedicated storage server and automatic recovery in case of failure Implement searchable and achievable audit trails on the web page of all user actions.
...
2. Design document UI/UX design (Figma) 3. Test cases and UAT report
